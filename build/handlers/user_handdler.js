...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, users.show(req.params.id)];
            case 1:
                User = _a.sent();
                res.json(User);
                return [2 /*return*/];
...
var auth = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, users.authenticate(req.body.username, req.body.password)];
            case 1:
                user = _a.sent();
...
var UserRoutes = function (app) {
    app.get('/users', authverfiy_1.verifyAuthToken, index);
    app.get('/users/:id', authverfiy_1.verifyAuthToken, show);
    app.post('/users', create);
    app.delete('/users', authverfiy_1.verifyAuthToken, destroy);
    app.put('/users/:id', authverfiy_1.verifyAuthToken, update);
