...
var OrderStore = /** @class */ (function () {
    ...
    OrderStore.prototype.create = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, orderres, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        result = _a.sent();
                        orderres = result.rows[0];
                        conn.release();
                        return [2 /*return*/, orderres];
                    case 3:
                        err_3 = _a.sent();
    ...
    OrderStore.prototype.update = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, orderres, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "UPDATE orders\n                SET status = $1 , user_id=$2 \n                WHERE id = ".concat(order.id, "\n                RETURNING *");
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update. Error: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not delete orders ".concat(id, ". Error: ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not find order for user current. Error: ".concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.complete = function (id, user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "UPDATE orders\n      SET status = 'complete'\n      WHERE user_id =".concat(user_id, " and id=").concat(id, "\n      RETURNING *");
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql)];
                    ...
                    case 3:
                        err_7 = _a.sent();
                        throw new Error("Could not find order for user current. Error: ".concat(err_7));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var ordersql, conn, result, order, err_8, sql, conn, result, order, err_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 7:
                        err_9 = _a.sent();
                        throw new Error("Could not add product ".concat(productId, " to order ").concat(orderId, ": ").concat(err_9));
